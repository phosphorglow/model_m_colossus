...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP( \
        ...
        LALT,       LGUI,                    SPC,                  RGUI,         FN3,        LEFT,  DOWN, RIGHT),
    ...
    KEYMAP( \
        ...
        FN4,  TRNS, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, TRNS, TRNS,  TRNS,  TRNS, TRNS,  TRNS,  TRNS, TRNS, \
    ...
    KEYMAP( \
        TRNS,       TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, TRNS, TRNS,  TRNS,  TRNS,        TRNS,  TRNS, TRNS, \
        FN6,  TRNS, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, TRNS, TRNS,  TRNS,  TRNS, TRNS,  TRNS,  TRNS, TRNS, \
        TRNS, TRNS, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, TRNS, TRNS,  TRNS,  TRNS,        TRNS,  TRNS, TRNS, \
        TRNS, TRNS, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, TRNS, TRNS,  TRNS,  TRNS, \
        TRNS, TRNS, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, TRNS, TRNS,  TRNS,  TRNS,               TRNS, \
        TRNS,       TRNS,                    TRNS,                 TRNS,         TRNS,        TRNS,  TRNS, TRNS)
...
const uint16_t PROGMEM fn_actions[] = {
   ...
   [3] = ACTION_LAYER_TAP_KEY(2, KC_CAPS),	// make function 3 available
   [4] = ACTION_LAYER_SET(3, ON_PRESS),   	// regular PC layout
   [5] = ACTION_LAYER_TAP_KEY(4, KC_CAPS),	// make function 4 available
   [6] = ACTION_LAYER_SET_CLEAR(0),   		// default Mac layout
};